...
// Integration of an rotary encoders with push button ( KY-040 )
#define ROTARYENCODER      // un/comment this line to disable or enable the use of on Rotary Encoder as Volume Controll
...
#define LED_COUNT  8             // Anzahl an LEDs im Ring oder Strip
